...
import '../util/codegen_dependency_tracker.dart';
...
class CppModelBuilder implements Builder {
  ...
  Future<void> build(BuildStep buildStep) async {
    ...
    await CodegenDependencyTracker.run(buildStep, (dependencyTracker) async {
      cleanModelClassInfoCache();

      // A list of models that are in this file. We use this while generating
      // imports to ensure that the generated imports are only for fields that
      // are not hidden.
