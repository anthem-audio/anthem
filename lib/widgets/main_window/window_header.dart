  ...
  Widget build(BuildContext context) {
    return Button(
      ...
      borderRadius: BorderRadius.only(
        topLeft: isFirst ? Radius.circular(3) : Radius.zero,
        bottomLeft: isFirst ? Radius.circular(3) : Radius.zero,
        topRight: isLast ? Radius.circular(3) : Radius.zero,
        bottomRight: isLast ? Radius.circular(3) : Radius.zero,
      ),
