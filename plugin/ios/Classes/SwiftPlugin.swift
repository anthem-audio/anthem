...
func dummyCallsToPreventTreeShaking() {
    ...
    rid_pattern_generator_notes(nil);
    ...
    rid_export_rid_len_hash_map_u64_generatornotes(nil);
    rid_export_rid_get_hash_map_u64_generatornotes(nil, 0);
    rid_export_rid_contains_key_hash_map_u64_generatornotes(nil, 0);
    rid_export_rid_keys_hash_map_u64_generatornotes(nil);
    __include_dart_for_ridvec_u64();
    rid_free_ridvec_u64(RidVec_u64());
    rid_get_item_ridvec_u64(RidVec_u64(), 0);
    _to_dart_for_GeneratorNotes();
    __include_dart_for_vec_note();
    rid_generatornotes_notes(nil);
    ...
    rid_song_pattern_order(nil);
    rid_song_active_pattern_id(nil);
    rid_song_active_instrument_id(nil);
    rid_song_active_controller_id(nil);
    rid_export_rid_len_hash_map_u64_pattern(nil);
    rid_export_rid_get_hash_map_u64_pattern(nil, 0);
    rid_export_rid_contains_key_hash_map_u64_pattern(nil, 0);
    rid_export_rid_keys_hash_map_u64_pattern(nil);
    _to_dart_for_Store();
    create_store();
    rid_store_unlock();
    rid_store_free();
    ...
    rid_export_rid_len_hash_map_u64_project(nil);
    rid_export_rid_get_hash_map_u64_project(nil, 0);
    rid_export_rid_contains_key_hash_map_u64_project(nil, 0);
    rid_export_rid_keys_hash_map_u64_project(nil);
    ...
    rid_msg_Undo(0, 0);
    rid_msg_Redo(0, 0);
    rid_msg_JournalStartEntry(0, 0);
    rid_msg_JournalCommitEntry(0, 0);
    rid_msg_AddInstrument(0, 0, nil, 0);
    rid_msg_AddController(0, 0, nil, 0);
    ...
    rid_msg_MoveNote(0, 0, 0, 0, 0, 0, 0);
    rid_msg_ResizeNote(0, 0, 0, 0, 0, 0);
