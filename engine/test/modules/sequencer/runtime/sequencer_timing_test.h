...
public:
  ...
  void runTest() override {
    ...
    expect(
      nearlyEqual(
        sequencer_timing::tickDeltaToSampleOffset(1.0, timingParams),
        250.0
      ),
    ...
    expect(
      nearlyEqual(
        sequencer_timing::tickDeltaToSampleOffset(0.512, timingParams),
        128.0
      ),
    ...
    expect(
      nearlyEqual(
        sequencer_timing::sampleCountToTickDelta(250.0, timingParams),
        1.0
      ),
    ...
    auto ticksForBlock =
      sequencer_timing::sampleCountToTickDelta(256.0, timingParams);

    expect(
      nearlyEqual(
        sequencer_timing::tickDeltaToSampleOffset(ticksForBlock, timingParams),
        256.0
      ),
    ...
    expectEquals(
      sequencer_timing::sampleCountToTickDelta(
        1.0,
        sequencer_timing::TimingParams{
          .ticksPerQuarter = 0,
          .beatsPerMinute = 120.0,
    ...
    expect(
      nearlyEqual(
        sequencer_timing::wrapPlayheadToLoop(17.0, 10.0, 14.0),
        13.0
      ),
    ...
    expect(
      nearlyEqual(
        sequencer_timing::wrapPlayheadToLoop(9.0, 10.0, 14.0),
        13.0
      ),
    ...
    expect(
      nearlyEqual(
        sequencer_timing::advancePlayheadByTickDelta(13.0, 2.0, 10.0, 14.0),
        11.0
      ),
    ...
    expect(
      nearlyEqual(
        sequencer_timing::advancePlayheadByTickDelta(
          13.0,
          2.0,
          0.0,
