/*
  This file is modified from the original juce_events.cpp. Modifications are
  called out below with comments matching the following:

  // Modified from juce_events.cpp
...
// Modified from juce_events.cpp
//
// Change: Changed to use our custom juce_events_wasm.h
#include "juce_events_wasm.h"
