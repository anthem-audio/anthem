/*
  This file is modified from the original juce_core.cpp. Modifications are
  called out below with comments matching the following:
...
// Modified from juce_core.cpp
//
// Change: Changed to use our custom juce_core_wasm.h
...
// Modified from juce_core.cpp
//
// Change: Added #define and #undef of JUCE_LINUX for
// juce_ThreadPriorities_native.h.
//
// Rationale: juce_ThreadPriorities_native.h checks for various platform
// defines, but doesn't include a check for JUCE_WASM. It fails to compile
// unless one of these are defined. Since Emscripten uses POSIX threads,
// the Linux thread priority definitions are fine.
#define JUCE_LINUX 1
