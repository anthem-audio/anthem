...
public:
  ...
  // Iterators
  typename std::unordered_map<Key, T, Hash, KeyEqual>::iterator begin() {
    return data.begin();
  }
  typename std::unordered_map<Key, T, Hash, KeyEqual>::const_iterator begin() const {
    return data.begin();
  }
  typename std::unordered_map<Key, T, Hash, KeyEqual>::iterator end() {
    return data.end();
  }
  typename std::unordered_map<Key, T, Hash, KeyEqual>::const_iterator end() const {
    return data.end();
  }
  ...
  template <typename M>
  typename std::unordered_map<Key, T, Hash, KeyEqual>::iterator insert_or_assign(
      typename std::unordered_map<Key, T, Hash, KeyEqual>::const_iterator hint, Key&& k, M&& obj) {
  ...
  typename std::unordered_map<Key, T, Hash, KeyEqual>::iterator find(const Key& key) {
    return data.find(key);
  }
  typename std::unordered_map<Key, T, Hash, KeyEqual>::const_iterator find(const Key& key) const {
    return data.find(key);
  }
